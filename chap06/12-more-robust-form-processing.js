...
// THis sets the view engine for handlebars in app
app.engine('handlebars', expressHandlebars.engine({
    defaultLayout: 'main'
}))
app.set('view engine', 'handlebars')

// this is necessary to parse form response
...
//see the views/10-home file for the contents of this view
app.get('*', (req,res) => res.render('11-home'))

app.post('/process-contact', (req,res) => {
    try{
        //here's where we should try to save contact to database or other 
        ...
        // here's where we would handle any persistent errors
        console.log(`error processing contact from ${req.body.name}` +
        `<${req.body.email}>`)
        res.format({
